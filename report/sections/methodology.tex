...
\begin{itemize}
    \item Cross-model robustness (KNN vs Logistic vs SVM)
    \item Modality-specific sensitivity (ACCL vs GYRO)
    \item Performance degradation trends across corruption severity

This design ensures that corruption is isolated to specific modalities, allowing controlled analysis of modality-specific robustness.

...
utilizing it to extract information \cite{lara-2013}. The recognition of human activites has
many uses in healthcase, monitoring, and human-computer interaction \cite{lara-2013}.
...
The resulting corruption span a broad range of failures that go beyond simple missing data,
...
three dimensions: corruption type, granularity, and severity. Our framework applies six sensor

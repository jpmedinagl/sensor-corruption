...
and granularity. We apply six physically motivated fault types: stochastic noise, dropout, bias,
...
degradation, while dropout produces less significant peformance drops. The findings indicate the

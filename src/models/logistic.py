...
def evaluate_logistic(X_train, y_train, X_test, y_test, label: str):
    ...
    print(f"=== Logistic Regression Results ({label}) ===")
...
def evaluate_logistic_with_corruption(corruption_type: str, channels, severities):
    ...
    print(f"=== Logistic Corruption Results: {corruption_type}, channels={channel_name(channels)} ===")
...
def main():
    ...
    # -------------------------
    # GAIN (attenuation only)
    # gain < 1 reduces signal magnitude and better matches
    # sensor degradation / weakening.
    # -------------------------
    evaluate_logistic_with_corruption(
